...
dnsseed: dns.o umkoin.o netbase.o protocol.o db.o main.o util.o
	g++ -pthread $(LDFLAGS) -o releases/dnsseed dns.o umkoin.o netbase.o protocol.o db.o main.o util.o -lcrypto
